...
public class ReviewScript : MonoBehaviour
{
    ...
    {
        "Это обзор игры Pong, для чтения которого нужно играть в Pong. Если вы проиграете, придётся читать сначала.",
        ...
        "Плюсы: простой, но увлекательный геймплей, прошедший проверку временем.\n\nМинусы: кривоватая обработка соприкосновений палки и шарика, которую мне лень исправлять.",
    };
